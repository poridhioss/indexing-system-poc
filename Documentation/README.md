...
| **Lab 05** | File Watcher Implementation | Done | Build file system watcher to detect code changes in real-time |
| **Lab 06** | Chunk Hashing Strategies | Done | Implement content-based hashing for chunks (SHA-256) with dirty queue |
...
Building the file watching, hashing, and Merkle tree system for efficient incremental updates.
